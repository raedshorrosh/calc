...
[[comment]] ver 1.17 original code with table height listener [[/comment]]
...
if  (!answered ) 
{
 ...
 if (typeof stack_js !== 'undefined') {
     const resizeObserver = new ResizeObserver(() => {
         try {
             // Get the scroll height of the body, adding a 20px padding
     ...
     // Observe the body to catch row expansions and dropdown openings
     resizeObserver.observe(document.body);

     // Observe the table container directly
